...
<div class="container">
		...
		<div class="ticket-box animated fadeInUp">
			<div class="box-header">
				<h2>Remove Expense Type </h2>
			<form action="RemoveExpenseTypeInfo.php" method="post">
			</div>
			Error Removing Expense Type, Try Again!
			<br/>
			...
			<br/>
			<br/>
			<button type="submit">Remove Expense Type</button>
			<br/>
			</form>
		</div>
	</div>
