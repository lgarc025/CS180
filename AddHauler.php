...
<ul>
    ...
    <li><a class="active"href="#news">Haulers</a></li>
     ...
     <div class="container">
		...
		<div class="ticket-box animated fadeInUp">
			<div class="box-header">
				<h2>Add New Hauler </h2>
			<form action="AddHaulerInfo.php" method="post">
			</div>
			<label for="haulername">Enter Hauler Name:</label>
			<br/>
			<input type="text" name="haulername" id="haulername">
			<br/>
			<button type="submit">Add Hauler</button>
			<br/>
			</form>
		</div>
	</div>
