...
<div class="container">
		...
		<div class="ticket-box animated fadeInUp">
			<div class="box-header">
				<h2>Unpaid Ticket Search </h2>
			<form action="OwnerGenRepDisplayTicketSearch.php" method="post">
			</div>
			<br/>
			<label for="time">Enter TicketID:</label>
			<br/>
			...
			<form action="TicketSearchSubmit.php" method="post">
			<br/>
			<?php include('TicketSearchInfo.php'); ?>
			<br/>
			<button type="submit">Submit Paid List</button>
			<br/>
			</form>
		</div>
	</div>
