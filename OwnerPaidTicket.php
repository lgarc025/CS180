...
<div class="container">
		...
		<div class="ticket-box animated fadeInUp">
			<div class="box-header">
				<h2> Update Paid Tickets </h2>
			<form action="OwnerPaidTicket.php" method="post">
			</div>
			...
			<br/>
			<br/>
			<form action="OwnerPaidTicketSubmit.php" method="post">
			<?php include('OwnerPaidTicketInfo.php'); ?>
			<br/>
